...
start(LoggedIn, Threads) ->
    receive
        ...
        {client_register, ClientPid, Username, Password} ->
            ...
            if (length(Threads) == ?MaxThreads) ->
                Pid2 = server_wait(),
                NewThreads = lists:delete(Pid2, Threads);
            true ->
                NewThreads = Threads
            end,
            SpawnThread = spawn(server_automated, register_user, [ClientPid, Username, Password]),
        ...
        {client_login, ClientPid, Username, Password} ->
            ...
            SpawnThread = spawn(server_automated, login_user, [ClientPid, Username, Password]),
            monitor(process, SpawnThread),
            start(LoggedIn, NewThreads ++ [SpawnThread]);
        ...
        {client_tweet, Username, Tweet} ->
            ...
            SpawnThread = spawn(server_automated, client_tweet, [Username, Tweet]),
            monitor(process, SpawnThread),
            start(LoggedIn, NewThreads ++ [SpawnThread]);
        ...
        {server_tweet, Status, Username, FinalUsers, Tweet, TweetId} ->
            ...
            spawn(server_automated, send_tweets, [Tweet, FinalUsers, LoggedIn, Username, TweetId]),
            start(LoggedIn, Threads);
        ...
        {client_subscribe_to, Username, Name} ->
            ...
            SpawnThread = spawn(server_automated, subscribe_to, [Username, Name]),
            monitor(process, SpawnThread),
            start(LoggedIn, NewThreads ++ [SpawnThread]);
        ...
        {client_query, Username, Name} ->
            ...
            SpawnThread = spawn(server_automated, query_tweets, [Username, Name]),
            monitor(process, SpawnThread),
            start(LoggedIn, NewThreads ++ [SpawnThread]);
        ...
        {client_retweet, Username, TweetId} ->
            ...
            SpawnThread = spawn(server_automated, retweet, [Username, TweetId]),
            monitor(process, SpawnThread),
            start(LoggedIn, NewThreads ++ [SpawnThread]);
